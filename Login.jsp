...
<div class="error-pagewrap">
		<div class="error-page-int">
			<div class="text-center m-b-md custom-login">
				<h3>PLEASE LOGIN TO SRMS APP</h3>
                    ...
                    <div class="panel-body">
                        ...
                        <form action="Login" id="loginForm" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="T/UDOM/0000/00000" title="Please enter you username" required value="" name="username" id="username" class="form-control">
                            ...
                            <a class="btn btn-default btn-block" href="Register_Student.jsp">Register</a>
                        </form>
